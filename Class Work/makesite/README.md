...
- [x] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
    ...
    - [x] **_FILL IN THE BLANK_**: I will use the `github.com/begmaroman/reading-time` library. The documentation is located at https://github.com/begmaroman/reading-time. My goal is to use it to calculate the amount of time it takes to read each blog post and render this information as part of the template.
- [x] **Add, commit, and push to GitHub**.
